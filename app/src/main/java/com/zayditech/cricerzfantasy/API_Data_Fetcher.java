...
public class API_Data_Fetcher extends AsyncTask<String, String, String> {
    ...
    public API_Data_Fetcher(Context appContext) {
        context = appContext;
    ...
    protected String doInBackground(String... params) {
        Looper.prepare();
        GeneralMethods gms = new GeneralMethods(context);
        try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        switch(jsonObject.getInt("pid")) {
                            ...
                            case 44828:
                                ...
                                json.put("team", "QG");
                                json.put("playingRole", "Batsman");
                                json.put("imageURL", "https://www.cricapi.com/playerpic/44828.jpg");
                                break;
                            ...
                            case 470633:
                                ...
                                json.put("team", "PZ");
                                json.put("playingRole", "Batsman");
                                json.put("imageURL", "https://www.cricapi.com/playerpic/470633.jpg");
                                break;
                            //Peshawar Zalmi - end
                            ...
                            case 240609:
                                ...
                                json.put("team", "IU");
                                json.put("playingRole", "Bowler");
                                json.put("imageURL", "https://m.cricbuzz.com/a/img/v1/192x192/i1/c152394/fawad-ahmed.jpg");
                                break;
                            case 303427:
                                json.put("value", 11);
                                json.put("team", "IU");
                                json.put("playingRole", "All Rounder");
                                json.put("imageURL", "https://www.cricapi.com/playerpic/303427.jpg");
                                break;
                            case 927119:
                                json.put("value", 10);
                                json.put("team", "IU");
                                json.put("playingRole", "Bowler");
                                json.put("imageURL", "https://www.cricapi.com/playerpic/927119.jpg");
                                break;
